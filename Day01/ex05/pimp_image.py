...
def ft_grey(array) -> np.ndarray:
    try:
        ...
        newArray[:, :, 0] = (newArray[0:, :, 0] + newArray[0:, :, 1] + newArray[0:, :, 2]) / 3
        newArray[:, :, 1] = (newArray[0:, :, 0] + newArray[0:, :, 1] + newArray[0:, :, 2]) / 3 
        newArray[:, :, 2] = (newArray[0:, :, 0] + newArray[0:, :, 1] + newArray[0:, :, 2]) / 3 
        return (newArray)
    except FileNotFoundError:
        print(f"Error: File '{path}' not found.")
    except Exception as e:
